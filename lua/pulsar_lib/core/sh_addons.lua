...
-- function PulsarLib.Addons.Load(addon)
-- 	if not addon then
-- 		PulsarLib.Logging:Error("Unable to load addon with no name.")
-- 		return
-- 	end
-- 	if not PulsarLib.Addons.WaitingForLoad[addon] then
-- 		PulsarLib.Logging:Error("Addon " .. addon .. " is not waiting to load!")
-- 		return
-- 	end
-- 	PulsarLib.Logging:Info("Loading addon " .. addon .. "...")
-- 	//PulsarLib.Addons.WaitingForLoad[addon] = nil
-- 	local addonHandler = PulsarLib.Addons.stored[addon]
-- 	if not addonHandler then
-- 		PulsarLib.Logging:Error("Addon " .. addon .. " has no handler.")
-- 		return
-- 	end
-- 	if addonHandler.Folder and PulsarLib.Addons.WaitingForLoad[addon] then
-- 		addonHandler.GlobalVar:Include(addonHandler.Folder .. "/sh_init.lua", "sh", true)
-- 		if addonHandler.OnLoad then
-- 			addonHandler:OnLoad()
-- 		end
-- 	else
-- 		if not addonHandler.Folder then
-- 			PulsarLib.Logging:Error("Addon " .. addon .. " has no folder.")
-- 		else
-- 			PulsarLib.Logging:Error("Addon " .. addon .. " is not loadable.")
-- 		end
-- 		return
-- 	end
-- 	PulsarLib.Logging:Info("Addon " .. addon .. " has loaded.")
-- end
-- function PulsarLib.Addons.LoadAll()
-- 	PulsarLib.Logging:Info("Loading all addons...")
-- 	for addon, _ in pairs(PulsarLib.Addons.WaitingForLoad) do
-- 		PulsarLib.Addons.Load(addon)
-- 	end
-- end